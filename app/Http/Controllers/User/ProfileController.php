...
//        $country_id =
	...
	public function create_business()
	{
		...
		return view('user.profile.edit_business', compact('different', 'countries','industries'));
	}
	...
	public function create_world()
	{
		...
		return view('user.profile.edit_world', compact('different', 'countries','industries'));
	}
...
//		return $different;
	...
	function store_edit_business(Request $request)
	{
		...
		$this->storeDifferentProfilePicture($request, $user);
		$different = $user->type;
//		return $request->industry_id;
		$different->industry_id=$request->industry_id;
		$different->fill($request->input());
...
//        return $request->file('profile_picture');
		...
		$rules =
			['profile_picture' => 'required|mimes:jpeg,bmp,png,jpg',]; //mimes:jpeg,bmp,png and for max size max:10000
