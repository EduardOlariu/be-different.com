		...
		<div class="row-fluid" >
			<div class="col-md-5 col-sm-5 col-xs-12" >
				...
				<p style="color:#0e0e0e; background-color:#c1c1c1; margin-right:40px;" >Membership requires a
				                                                                        specific background. Its a
				                                                                        privat community and a Different
				                                                                        Business network. The Membership
				                                                                        Applications will be approved by
				                                                                        our international Foundation Be
				                                                                        Different Committee. All the
				                                                                        information will be send to you
				                                                                        by e mail upon registration. The
				                                                                        annual membership fee represent
				                                                                        a donation for the Be Different
				                                                                        Foundation. Members will receive
				                                                                        an Enrollment Pack.</p >
			</div >
